  ...
  return (
    <div className="relative">
      ...
      <section className="relative pt-40 pb-24 overflow-hidden">
        ...
        <div className="absolute top-1/3 right-1/4 w-[600px] h-[600px] bg-futuri-red/8 rounded-full blur-[150px]" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold tracking-tight leading-[0.95] mb-6 text-white">
              ...
              <br />
              of{" "}
              <span className="gradient-text-content">
                your audience
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center px-8 py-4 text-base font-semibold rounded-xl bg-gradient-to-r from-futuri-red to-futuri-yellow text-white hover:shadow-xl hover:shadow-red-500/25 transition-all duration-300 hover:-translate-y-0.5"
              >
                Request a Demo
              </Link>
              <Link
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {metrics.map((m, i) => (
                <AnimatedSection key={m.label} delay={i * 0.1} className="text-center">
                  <div className="text-3xl sm:text-4xl font-bold gradient-text-content mb-1">
                    {m.value}
                  </div>
            ...
            {features.map((f, i) => (
              <AnimatedSection key={f.title} delay={i * 0.1}>
                <div className="glass rounded-2xl p-8 h-full hover:bg-white/[0.06] transition-all duration-300">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-red-500 to-yellow-400 flex items-center justify-center text-white mb-5">
                    {f.icon}
                  </div>
            ...
            {[
              ...
              <AnimatedSection key={s.step} delay={i * 0.1}>
                <div className="text-center">
                  <div className="text-5xl font-bold font-mono text-futuri-red/20 mb-3">{s.step}</div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <AnimatedSection>
            <div className="relative rounded-3xl overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-futuri-red/15 via-futuri-black to-yellow-500/20" />
              <div className="relative z-10 px-8 py-20 md:px-16 md:py-24 text-center">
                ...
                <Link
                  href="/contact"
                  className="inline-flex px-8 py-4 text-base font-semibold rounded-xl bg-gradient-to-r from-futuri-red to-futuri-yellow text-white hover:shadow-xl hover:shadow-red-500/25 transition-all duration-300 hover:-translate-y-0.5"
                >
                  Schedule a Demo
                </Link>
              </div>
