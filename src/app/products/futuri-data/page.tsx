  ...
  return (
    <div className="relative">
      ...
      <section className="relative pt-40 pb-24 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-futuri-green via-futuri-cyan to-futuri-blue opacity-60" />
        <div className="absolute top-1/3 left-1/4 w-[600px] h-[600px] bg-futuri-green/5 rounded-full blur-[150px]" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <span className="inline-block text-xs font-mono font-semibold text-futuri-green uppercase tracking-[0.2em] mb-4">
      ...
      <section id="journey" className="relative py-32">
        <div className="max-w-7xl mx-auto px-6">
          <AnimatedSection className="text-center mb-16">
            <p className="text-xs font-mono font-semibold text-futuri-green uppercase tracking-[0.2em] mb-4">
              The Data Journey
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <AnimatedSection>
            <div className="relative rounded-3xl overflow-hidden">
              ...
              <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-futuri-green to-futuri-cyan" />
