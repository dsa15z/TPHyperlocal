...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/beat-alerts", label: "Beat Alerts", icon: <AlertTriangle className="w-4 h-4" />, section: "main" },
  { href: "/assignments", label: "Assignments", icon: <ClipboardCheck className="w-4 h-4" />, section: "main" },
  { href: "/reporters", label: "Reporters", icon: <Users className="w-4 h-4" />, section: "main" },
  { href: "/deadlines", label: "Deadlines", icon: <Timer className="w-4 h-4" />, section: "main" },
  { href: "/lineup", label: "Show Lineup", icon: <ListOrdered className="w-4 h-4" />, section: "main" },
  { href: "/show-prep", label: "Show Prep", icon: <Mic2 className="w-4 h-4" />, section: "main" },
  { href: "/publish", label: "Publish Queue", icon: <Send className="w-4 h-4" />, section: "main" },
  { href: "/video", label: "Video Studio", icon: <Video className="w-4 h-4" />, section: "main" },
  { href: "/briefings", label: "Shift Briefings", icon: <FileText className="w-4 h-4" />, section: "main" },
  { href: "/predictions", label: "Predictions", icon: <TrendingUp className="w-4 h-4" />, section: "main" },
  { href: "/alerts", label: "Public Alerts", icon: <Bell className="w-4 h-4" />, section: "main" },
  ...
  { href: "/admin/hyperlocal-intel", label: "HyperLocal Intel", icon: <Globe className="w-4 h-4" />, section: "admin" },
  { href: "/admin/broadcast-monitor", label: "Broadcast Monitor", icon: <Tv className="w-4 h-4" />, section: "admin" },
  ...
  { href: "/admin/social-accounts", label: "Social Accounts", icon: <Share2 className="w-4 h-4" />, section: "admin" },
  { href: "/admin/cms-publish", label: "CMS Publishing", icon: <Globe className="w-4 h-4" />, section: "admin" },
  { href: "/admin/mos-integration", label: "ENPS / iNews", icon: <MonitorPlay className="w-4 h-4" />, section: "admin" },
  ...
  { href: "/admin/superadmin", label: "Super Admin", icon: <Crown className="w-4 h-4" />, section: "admin" },
